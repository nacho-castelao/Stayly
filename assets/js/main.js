  ...
  return ` <div class="property-card">
                ...
                <div class="property-info">
                    ...
                    <div class="property-footer">
                        <span class="property-price"><span>${element.price_per_night}</span>€/night</span>
                        <a href="${BASE_URL}/public/Property/showOne?id=${element.id}" class="property-btn">View property</a>
                    </div>
                </div>
              </div>
            `;
