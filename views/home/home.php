...
<div class="pagination-wrapper">
    <nav class="pagination" aria-label="Pagination">
        ...
        <!-- First page -->
        <a href="?page=1" class="page-btn nav-btn" aria-label="First page">
            <span>&#171;</span>
        </a>

        <!-- Previous page -->
        <a href="?page=<?= $page - 1 ?>" class="page-btn nav-btn" aria-label="Previous page">
            <span>&#8249;</span>
        </a>

        <!-- Page numbers -->
        <?php for ($i = 1; $i <= $totalPages; $i++): ?>
            <a href="?page=<?= $i ?>" class="page-btn <?= $i === $page ? 'active' : '' ?>" aria-current="page" aria-label="Page <?= $i ?>"><?= $i ?></a>
        <?php endfor; ?>
        <!-- Ellipsis -->
        <span class="page-ellipsis" aria-hidden="true">&#8230;</span>

        <!-- Last visible page -->
        <a href="?page=<?= $totalPages ?>" class="page-btn" aria-label="Page 10"><?= $totalPages ?></a>

        <!-- Next page -->
        <a href="?page=<?= $page + 1 ?>" class="page-btn nav-btn" aria-label="Next page">
            <span>&#8250;</span>
        </a>

        <!-- Last page -->
        <a href="?page=<?= $totalPages ?>" class="page-btn nav-btn" aria-label="Last page">
            <span>&#187;</span>
        </a>
    </nav>
</div>